...
import { BLACK, GRAY, LIGHTGREEN, ORANGE, SHADOW } from '../../modules/const'
...
const drawRightPanel = (p5: p5Types, left: Landmark[], right: Landmark[]) => {
  ...
  let leftColor = lz > threshold ? LIGHTGREEN() : GRAY()
  let rightColor = rz > threshold ? ORANGE() : GRAY()
  ...
  p5.text('0.53', 0, (p5.height - 50) / 2)
  p5.text('1', 0, 30)
  p5.strokeWeight(2)
  p5.stroke(0)
  p5.line(50, 25, 50, p5.height - 82)
  p5.line(50, p5.height - 82, 310, p5.height - 82)
  
  p5.noStroke()
  p5.fill(SHADOW(30))
  p5.rect(50, 25, 260, p5.height - 107)

  bar(p5, 60, avgLZ * vertScale, leftColor)
  p5.fill(BLACK())
  p5.text(`L: ${avgLZ.toFixed(2)}`, 60, p5.height - 40)

  bar(p5, 170, avgRZ * vertScale, rightColor)
  p5.fill(BLACK())
  p5.text(`R: ${avgRZ.toFixed(2)}`, 170, p5.height - 40)
}
